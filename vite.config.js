                ...
                configureServer(server) {
                    server.middlewares.use("/api/film-title", async (req, res) => {
                        ...
                        try {
                            ...
                            const dialogueLanguages = "dialogueLanguages" in result && Array.isArray(result.dialogueLanguages) ? result.dialogueLanguages : [];
                            ...
                            const countryOfOrigin = "countryOfOrigin" in result && typeof result.countryOfOrigin === "string" ? result.countryOfOrigin : null;
                            const premiereYear = "premiereYear" in result && typeof result.premiereYear === "number" ? result.premiereYear : null;
                            res.statusCode =
                                result.title ||
                                    originalTitle ||
